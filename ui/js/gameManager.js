...
function checkSession() {
   if (sessionStorage.getItem("id") == "" || sessionStorage.getItem("id") ==  null ) {
         window.location.href = config.env == "PROD" ? config.server.urlServer + "/game/espace_login.html" : config.server.urlLocalHost + "/game/espace_login.html" ;
   }else{
...
function playCountDown() {
    ...
    var downloadTimer = setInterval(function () {
        ...
        if (config.countDown < 0) {
            ...
            document.getElementById("countDown").innerHTML = "Start memorizing the boxes";
