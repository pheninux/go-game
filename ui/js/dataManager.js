    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if (dataToJson.err_msg == "") {
                ...
                window.location.href = config.env == "PROD" ? config.server.urlServer + "/game/html/espace_game.html" : config.server.urlLocalHost + "/game/html/espace_game.html";
            } else {
                $(".msg").html(dataToJson.err_msg);
            }
        }
    });
}
